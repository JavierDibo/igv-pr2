...
void igvInterfaz::keyboardFunc(unsigned char key, int x, int y) {
    switch (key) {
        ...
        case 'E':
            ...
            break;
        case 'x':
            _instancia->escena.incrementarInstanciasX();
            break;
        case 'X':
            _instancia->escena.decrementarInstanciasX();
            break;
        case 'y':
            _instancia->escena.incrementarInstanciasY();
            break;
        case 'Y':
            _instancia->escena.decrementarInstanciasY();
            break;
        case 'z':
            _instancia->escena.incrementarInstanciasZ();
            break;
        case 'Z':
            _instancia->escena.decrementarInstanciasZ();
            break;
